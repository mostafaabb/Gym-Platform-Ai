      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
        <div className="md:col-span-1 space-y-4">
           <div className="flex flex-col items-center p-8 rounded-3xl border border-white/5 bg-zinc-900/50 backdrop-blur-sm">
              ...
              <h3 className="mt-4 text-xl font-bold text-white">Felix Jones</h3>
              <p className="text-sm text-zinc-500">Elite Member</p>
           ...
           <nav className="space-y-1">
              ...
              <button className="flex w-full items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium text-red-500 hover:bg-red-500/10 transition-all mt-4">
                 <LogOut size={18} />
                 Logout
              </button>
           </nav>
           ...
           <div className="rounded-3xl border border-white/5 bg-zinc-900/30 p-8 space-y-6">
              <div className="grid grid-cols-2 gap-6">
                 <div className="space-y-2">
                    ...
                    <input type="text" defaultValue="Felix" className="w-full rounded-xl border border-white/5 bg-white/5 py-3 px-4 text-white outline-none focus:border-primary/50" />
                 </div>
                 <div className="space-y-2">
                    <label className="text-xs font-semibold text-zinc-500 uppercase tracking-wider">Last Name</label>
                    <input type="text" defaultValue="Jones" className="w-full rounded-xl border border-white/5 bg-white/5 py-3 px-4 text-white outline-none focus:border-primary/50" />
                 </div>
              </div>
              <div className="space-y-2">
                 ...
                 <div className="relative">
                    ...
                    <input type="email" defaultValue="felix@example.com" className="w-full rounded-xl border border-white/5 bg-white/5 py-3 pl-12 pr-4 text-white outline-none focus:border-primary/50" />
                 </div>
              </div>
              <div className="pt-4">
